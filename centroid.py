...
def sample_and_group(npoint, radius, nsample, xyz, points, returnfps=False):
    ...
    if points is not None:
        ...
        # print(f"centroid11 shape: {grouped_xyz_norm.shape}")
        # print(f"centroid12 shape: {grouped_points.shape}")
...
def sample_and_group_all(xyz, points):
    ...
    if points is not None:
        # print(f"centroid21 shape: {grouped_xyz.shape}")
        # print(f"centroid22 shape: {points.view(B, 1, N, -1).shape}")
    ...
    def forward(self, xyz, points):
        ...
        for i, radius in enumerate(self.radius_list):
            ...
            if points is not None:
                ...
                # print(f"centroid31 shape: {grouped_points.shape}")
                # print(f"centroid32 shape: {grouped_xyz.shape}")
        ...
        new_xyz = new_xyz.permute(0, 2, 1)
        # print(f"centroid41 shape: {new_points_list.shape}")
        # print(f"centroid42 shape: {1}")
...
class PointNetFeaturePropagation(nn.Module):
    ...
    def forward(self, xyz1, xyz2, points1, points2):
        ...
        if points1 is not None:
            ...
            # print(f"centroid51 shape: {points1.shape}")
            # print(f"centroid52 shape: {interpolated_points.shape}")
